      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="flex">
          <button
            ...
            value="sale"
            onClick={onChange}
            className={`mr-3 px-7 py-3 font-medium test-sm uppercase shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg w-full ${
              type === "rent"
                ? "bg-white text-black"
        ...
        <input
          ...
          minLength="10"
          required
          className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded focus:bg-white focus:border-slate-600 mb-6"
        />
        <div className="flex space-x-6 mb-6">
          <div>
            ...
            <input
              ...
              max="50"
              required
              className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded focus:bg-white focus:border-slate-600 text-center"
            />
          </div>
          <div>
